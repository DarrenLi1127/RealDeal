...
- Name: Profile Features >> user mush keep the username within 3 to 20 character
- Location: /Users/mac/Desktop/RealDeal/client/tests/e2e/profile.spec.ts:52:5
...
Locator: getByLabel('username-error')
Expected string: "Username must be between 3-20 characters"
Received: <element(s) not found>
Call log:
  - expect.toContainText with timeout 5000ms
  - waiting for getByLabel('username-error')

    at /Users/mac/Desktop/RealDeal/client/tests/e2e/profile.spec.ts:62:29
```
...
- main:
  ...
  - text: Username must be between 3-20 characters
  - img "Profile picture"
  - text: Change photo Username
  - textbox "Username-input": "12"
